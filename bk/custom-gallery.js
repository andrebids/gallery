jQuery(document).ready(function($) {
    ...
    function applyFilters(page = 1) {
        var searchImageName = $('#search-image-name').val().trim().toLowerCase();
        ...
        $.ajax({
            ...
            data: {
                ...
                search_image_name: searchImageName,
                tags: selectedTags,
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    updateFiltersSummary(searchImageName, selectedTags2D3D, selectedOtherTags, dimensions);
    ...
    function updateFiltersSummary(searchImageName, selectedTags2D3D, selectedOtherTags, dimensions) {
        var summaryHtml = '';
        if (searchImageName) {
            summaryHtml += '<div class="filter-item">Name: ' + searchImageName + ' <span class="remove-filter" data-filter="name">x</span></div>';
        }
